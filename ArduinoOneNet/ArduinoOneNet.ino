...
//配置ESP8266WIFI设置
#define SSID "rocket"    //填写2.4GHz的WIFI名称，不要使用校园网
#define PASSWORD "rocket3434"//填写自己的WIFI密码
#define HOST_NAME "api.heclouds.com"  //API主机名称，连接到OneNET平台，无需修改
#define DEVICE_ID "858906060"       //填写自己的OneNet设备ID
#define HOST_PORT (80)                //API端口，连接到OneNET平台，无需修改
String APIKey = "J8P4fXKY8q7d8E2H8fzALlG74iI="; //与设备绑定的APIKey
